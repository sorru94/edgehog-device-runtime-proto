...
pub struct ListRequest {
    ...
    /// "stopped").
    #[prost(enumeration = "ListStatusFilter", tag = "1")]
...
pub struct StatsResponse {
    ...
    pub prepared: ::core::option::Option<::prost_types::Timestamp>,
    /// Stats of a container's process-IDs (PIDs).
    #[prost(message, optional, tag = "4")]
    pub pids_stas: ::core::option::Option<PidsStats>,
...
pub struct BlkioStats {
    ...
    #[prost(message, repeated, tag = "1")]
    pub io_service_bytes_recursize: ::prost::alloc::vec::Vec<BlkioValue>,
    /// Available on hosts with cgroups v1
    #[prost(message, repeated, tag = "2")]
    pub io_service_recursize: ::prost::alloc::vec::Vec<BlkioValue>,
    /// Available on hosts with cgroups v1
    #[prost(message, repeated, tag = "3")]
    pub io_queue_recursize: ::prost::alloc::vec::Vec<BlkioValue>,
    /// Available on hosts with cgroups v1
    #[prost(message, repeated, tag = "4")]
    pub io_service_time_recursize: ::prost::alloc::vec::Vec<BlkioValue>,
    /// Available on hosts with cgroups v1
    #[prost(message, repeated, tag = "5")]
    pub io_wait_time_recursize: ::prost::alloc::vec::Vec<BlkioValue>,
    /// Available on hosts with cgroups v1
    #[prost(message, repeated, tag = "6")]
    pub io_merged_recursize: ::prost::alloc::vec::Vec<BlkioValue>,
    /// Available on hosts with cgroups v1
    #[prost(message, repeated, tag = "7")]
    pub io_time_recursize: ::prost::alloc::vec::Vec<BlkioValue>,
    /// Available on hosts with cgroups v1
    #[prost(message, repeated, tag = "8")]
    pub sectors_recursize: ::prost::alloc::vec::Vec<BlkioValue>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct CpuStats {
    ...
    pub online_cpus: ::core::option::Option<u64>,
...
pub struct Container {
    ...
    #[prost(enumeration = "ContainerStatus", tag = "5")]
    pub status: i32,
...
impl ListStatusFilter {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "LIST_STATUS_FILTER_UNSPECIFIED",
            Self::Running => "LIST_STATUS_FILTER_RUNNING",
            Self::Stopped => "LIST_STATUS_FILTER_STOPPED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "LIST_STATUS_FILTER_UNSPECIFIED" => Some(Self::Unspecified),
            "LIST_STATUS_FILTER_RUNNING" => Some(Self::Running),
            "LIST_STATUS_FILTER_STOPPED" => Some(Self::Stopped),
            _ => None,
        }
    }
}
...
impl ContainerStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "CONTAINER_STATUS_UNSPECIFIED",
            Self::Created => "CONTAINER_STATUS_CREATED",
            Self::Running => "CONTAINER_STATUS_RUNNING",
            Self::Paused => "CONTAINER_STATUS_PAUSED",
            Self::Restarting => "CONTAINER_STATUS_RESTARTING",
            Self::Removing => "CONTAINER_STATUS_REMOVING",
            Self::Exited => "CONTAINER_STATUS_EXITED",
            Self::Dead => "CONTAINER_STATUS_DEAD",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "CONTAINER_STATUS_UNSPECIFIED" => Some(Self::Unspecified),
            "CONTAINER_STATUS_CREATED" => Some(Self::Created),
            "CONTAINER_STATUS_RUNNING" => Some(Self::Running),
            "CONTAINER_STATUS_PAUSED" => Some(Self::Paused),
            "CONTAINER_STATUS_RESTARTING" => Some(Self::Restarting),
            "CONTAINER_STATUS_REMOVING" => Some(Self::Removing),
            "CONTAINER_STATUS_EXITED" => Some(Self::Exited),
            "CONTAINER_STATUS_DEAD" => Some(Self::Dead),
            _ => None,
        }
    }
}
